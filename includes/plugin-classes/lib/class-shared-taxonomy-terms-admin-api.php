 ...
 * Admin API class.
 */
class Shared_Taxonomy_Terms_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'shared-terms' ) . '" data-uploader_button_text="' . __( 'Use image', 'shared-terms' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'shared-terms' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'shared-terms' ) . '" />' . "\n";
